" Vim color file
" Name:       blw.vim
" Author:     Brent Walker <walkermundo@gmail.com>
" Version:    0.1
" Notes:      Originally based on evolution by Peter Lewis <pete@muddygoat.org>
...
" -> Line info
hi LineNr         guibg=#005f00 guifg=#FFFFFF gui=none term=NONE cterm=NONE ctermbg=22 ctermfg=15
...
" -> Search 
hi Search         guibg=#696567 guifg=#FFEE68 gui=none term=reverse cterm=NONE ctermbg=85 ctermfg=0
hi IncSearch      guibg=#696567 guifg=#FFEE68 gui=none term=reverse cterm=NONE ctermbg=85 ctermfg=0

" -> Diff
hi DiffAdd        guibg=Green guifg=White gui=none term=NONE cterm=NONE ctermbg=Green ctermfg=White
hi DiffDelete     guibg=Red guifg=White gui=none term=NONE cterm=NONE ctermbg=Red ctermfg=White
hi DiffChange     guibg=Yellow guifg=White gui=none term=NONE cterm=NONE ctermbg=Yellow ctermfg=White
hi DiffText       guibg=Magenta guifg=White gui=none term=NONE cterm=NONE ctermbg=Magenta ctermfg=White
...
hi Statement      guibg=#1F1F1F guifg=#E783E9 gui=none term=bold cterm=bold ctermbg=NONE ctermfg=39
...
hi Type           guibg=#1F1F1F guifg=#FFEE68 gui=none term=underline cterm=NONE ctermbg=NONE ctermfg=33
